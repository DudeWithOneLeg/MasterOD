...
export default function SelectLimit({setLimit, limit, viewAll}) {
        ...
        <div className="flex h-full justify-content-start items-center">
            <div className="flex flex-row w-fit rounded text-lg text-zinc-200 h-fit items-end mr-1">
                <button
                    ...
                    className={`px-1 text-2xl cursor-pointer flex items-center justify-center focus:outline-none border-b-2 ${
                        viewAll
                            ? "border-white-600"
                            : "border-zinc-900"
                    }`}
                ...
                <button
                    ...
                    className={`px-1 text-2xl cursor-pointer focus:outline-none border-b-2 ${
                        viewAll ? "border-zinc-900" : "border-white-600"
                    }`}
                >
                    Saved
                </button>
