...
export default function WelcomePage() {
    ...
    return (
        <div className="text-white p-2 flex flex-col w-full align-items-center h-screen overflow-y-scroll">
            ...
            <div className={`flex flex-col justify-self-center rounded ${isMobile ? 'w-full' : 'w-1/3'}`}>
            ...
            <span className='h-20'/>
            {isMobile ? <div className={`w-full flex flex-col justify-content-around align-items-center`}>
            ...
            <span className='h-20'/>
            <div className={`w-full flex flex-${isMobile ? 'col': 'row'} justify-content-around align-items-center bg-slate-700`}>
                <img src={savedSearches} className={`w-${isMobile ? 'full p-4': '1/3'} `} alt=''/>
                <div className='h-20' />

                <p className={`w-${isMobile ? 'full p-4': '1/3'} `}>
            ...
            <span className='h-20'/>
            {isMobile ?  <div className={`w-full flex flex-${isMobile ? 'col': 'row'} justify-content-around align-items-center`}>
                <img src={resultHistory} className={`w-${isMobile ? 'full p-4': '1/3'} `} alt=''/>
                <p className={`w-${isMobile ? 'full p-4': '1/3'} `}>
            ...
            <div className="w-full flex flex-row justify-content-around align-items-center">
                <p className='w-1/3'>
                You can view your recent search results and bookmark important links for future reference. Each entry displays the title, URL, and a brief description of the webpage. You can filter through all results or just your saved ones using the search bar at the top. This feature ensures that valuable information is never lost and can be quickly retrieved, providing a seamless and efficient search experience.
                <img src={resultHistory} className={`w-${isMobile ? 'full': '1/3'} `} alt=''/>
                </p>
            </div>
            }
        </div>
