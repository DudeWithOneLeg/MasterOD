    ...
    return (
        <div className="text-white w-screen bg-zinc-900 fixed h-[5vh] z-30 border-b border-zinc-500">
            {user ? (
                ...
                <div className="grid grid-cols-3 h-full items-center justify-between w-full text-zinc-700">
                    <p
                        className="p-1 rounded border !bg-white mx-1 justify-self-start"
                    ...
                    <p
                        className="p-1 rounded border bg-white mx-1 justify-self-end"
                        onClick={() => {
